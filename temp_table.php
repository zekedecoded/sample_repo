...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['delete'])) {
        $Record->deleteTemp($_POST['delete']);
    }
...
<body>
    ...
    <div class="container my-5">
        <h1 class="text-center mb-4">TEMPORARY RECORDS</h1>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex gap-2">
                                    <a href="includes/viewTemp.php?id=<?= $row['id'] ?>" class="btn btn-primary btn-sm">View</a>
                                    <a href="accept.php?id=<?= $row['id'] ?>" class="btn btn-warning btn-sm">Accept</a>
                                    <a href="decline.php?id=<?= $row['id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to decline this registration?');">Decline</a>
                                </div>
                            </td>
                        </tr>
                    <?php } ?>
